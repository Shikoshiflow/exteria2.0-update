// JavaScript код для последовательной анимации текста
...
// Дополнительный код для добавления событий интерактивности, если необходимо
/*
// Если вы хотите добавить кнопку для перезапуска анимации
const restartBtn = document.getElementById('restartBtn');
if (restartBtn) {
    restartBtn.addEventListener('click', startSequentialAnimation);
}
*/